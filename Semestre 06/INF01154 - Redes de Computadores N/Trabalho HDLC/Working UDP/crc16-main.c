...
u16 pppfcs16(u16 fcs, char address, char control, char *cp, int len, char * FCS)
{
   assert(sizeof (u16) == 2);
   assert(((u16) -1) > 0);
...
int  main(int argc, char **argv)
{
   ...
   while(count--) {
	   ...
	   */
	   ...
	   trialfcs  = pppfcs16( PPPINITFCS16, 'a', 'b', cp, len, NULL );
	   trialfcs  = trialfcs ^ 0xffff;  	          /* complement */
	   FCS[0]   = (char)(trialfcs & 0x00ff);         /* LSB first  */
	   FCS[1] = (char)((trialfcs >> 8) & 0x00ff);
	   ...
	   */  
	   ...
	   trialfcs = pppfcs16( PPPINITFCS16, 'a', 'b', cp, len, FCS );
