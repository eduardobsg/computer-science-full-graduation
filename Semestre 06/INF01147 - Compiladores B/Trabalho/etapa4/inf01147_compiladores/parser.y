...
command:
		identifier '=' exp					{ $$ = astreeCreate(ASTREE_SCALA_ASS, -1, getLineNumber(), NULL, $1, $3, NULL, NULL); }
	|	identifier '[' exp ']' '=' exp	{
	...
	|	KW_IF '(' exp ')' KW_THEN command 	{ $$ = astreeCreate(ASTREE_IF, -1, getLineNumber(), NULL, $3, $6, NULL, NULL);		}
	|	KW_IF '(' exp ')' KW_THEN command KW_ELSE command { $$ = astreeCreate(ASTREE_IF_ELSE, -1, getLineNumber(), NULL, $3, $6, $8, NULL); }
	|	KW_LOOP '(' exp ')' command 		{ $$ = astreeCreate(ASTREE_LOOP, -1, getLineNumber(), NULL, $3, $5, NULL, NULL);		}
...
exp_arit:
    	exp '+' exp 			{ $$ = astreeCreate(ASTREE_ADD, -1, getLineNumber(), NULL, $1, $3, NULL, NULL); }
