...
#define ASTREE_POINTER_REFERENCE		47
#define ASTREE_POINTER_REFERENCE_ARRAY  48
#define ASTREE_POINTER_DEREFERENCE		49
...
typedef struct astree_node {
	int nodeType;
	int contentType; //KW_WORD, KW_BOOL or KW_BYTE
	Entry *symbol;
	int lineNumber;
