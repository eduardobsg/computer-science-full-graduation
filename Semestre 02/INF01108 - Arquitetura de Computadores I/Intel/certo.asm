...
;         push   baite
	 push word ptr baite
;         pop    cs
;	 não pode operar sobre o cs, exceto com jmp far
;         add    palavra,palavra
	 mov	ax, palavra
	 add	palavra, ax
;         xor    ds,ds
...
;         and    si,ABCDH
	 and	si, 0ABCDH
         jnae   continua	; instrução correta, o erro era na definicão do rótulo "continua"
;         add    cl,300
	 add	cx, 300
         xlat   ; al
continua:
;         add    cl,300
	 add	cx, 300
;         sub    30,dl	; dado imediato não pode ser destino
	 sub	dl, 30
.386
         mul    pdupla
;         idiv   pquadr
