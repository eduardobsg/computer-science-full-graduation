...
void setGlui() {
	...
	glui->add_button_to_panel(obj_panel, "Save!", NULL, (GLUI_Update_CB)saveFile);
	glui->add_button_to_panel(obj_panel, "Reload Original Image", NULL, (GLUI_Update_CB)reloadFile);

	glui->add_separator();

	GLUI_Panel *obj_panel2 = glui->add_panel ("Flip");
	glui->add_button_to_panel(obj_panel2, "Hozirontal", NULL, (GLUI_Update_CB)horMirror);
