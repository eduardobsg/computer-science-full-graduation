...
void intercala(int p, int q, int r, int v[], long int *comp, long int *trocas)
{
     int i, j, k, *w;
...
void intercala2(int p, int q, int r, struct s_elemento v2[], long int *comp, long int *trocas)
{
     int i, j, k;
     struct s_elemento *w;
...
void ordenarMergeSort(int p, int r, int v[], long int *comp, long int *trocas)
{
     if (p < r - 1)
     {
	*comp = *comp + 1;
        int q = (p + r) / 2;   
        ordenarMergeSort(p, q, v, comp, trocas); //o e 2 //
        ordenarMergeSort(q, r, v, comp, trocas); //2 e 4 //3 4
        intercala(p, q, r, v, comp, trocas);
     }
     *comp = *comp + 1;
}

void ordenarMergeSort2(int p, int r, struct s_elemento v2[], long int *comp, long int *trocas)
{
     if (p < r - 1)
     {
	*comp = *comp + 1;
        int q = (p + r) / 2;   
        ordenarMergeSort2(p, q, v2, comp, trocas); //o e 2 //
        ordenarMergeSort2(q, r, v2, comp, trocas); //2 e 4 //3 4
        intercala2(p, q, r, v2, comp, trocas);
     }
     *comp = *comp + 1;
}
...
int main(int argc, char *argv[])
{    int *vetor;
	...
	for (i=0; i<tamanho; i++)	
	{
        ...
        ordenarMergeSort(0, tamanho, vetor, &comp, &trocas);
    }
	...
	for (i=0; i<tamanho; i++)	
        ...
        ordenarMergeSort2(0, tamanho, vetor2, &comp, &trocas);
    }
